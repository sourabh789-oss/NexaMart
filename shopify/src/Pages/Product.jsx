...
function Product() {
  ...
  return (<div> {loader ? (
    ...
    <Scrollbar />
    <h1 className='text-4xl text-center pb-3  font-serif text-[#27E0B3]'>Our Products</h1>
    <div className="Products mx-6 text-black   flex flex-row justify-center items-center bg-[#FFFFFD] flex-wrap gap-4 w-full py-3">
      {
